...
export const SHIP_CONFIGS: ShipConfig[] = [
  {
    ...
    description: [
      'The Tank is the ultimate in destructive capabilities.',
      'Meant to slug it out with larger ships, the Tank\'s armor & guns',
      'are formidable right off the bat.',
      'Item acquisition is much slower, but with increased firepower,',
      'the board should be littered with items from the carcasses of your enemies.',
    ],
    offsetY: 3.0,
    scaleSmall: 1.0,
    scaleLarge: 3.0,
  ...
  },
  {
    ...
    description: [
      'The Turtle is a modified Tank with a built-in high powered weapon:',
      'the Turtle Cannon. Destroys all visible targets at the cost of taking',
      'internal feedback damage when fired.',
      'Press [D] to activate Turtle Cannon.',
    ],
    offsetY: 0.0,
    scaleSmall: 1.0,
    scaleLarge: 3.0,
  ...
  },
  {
    ...
    description: [
      'The Flash is an experimental hybrid ship.',
      'Can transform between two states: Squid (speed) and Tank (firepower).',
      'Stand and fight or hit and run when necessary.',
      'Downside: The Flash cannot receive permanent stat upgrades.',
      'Press [D] to transform.',
    ],
    offsetY: 0.0,
    scaleSmall: 1.0,
    scaleLarge: 3.0,
  ...
  },
  {
    ...
    description: [
      'The Hunter is a fast, heavy missile corvette.',
      'Equipped with an array of 17 Piranha HeatSeeker missiles for offensive',
      'and defensive suppression.',
      'Hunter generates new missiles over time or collects HeatSeeker items.',
      'Press [D] to launch missiles.',
    ],
    offsetY: 0.0,
    scaleSmall: 1.0,
    scaleLarge: 3.0,
  ...
  },
  {
    ...
    description: [
      'The Flagship is a capital ship equipped with a massive Attractor / Repulser',
      '(A/R) unit that sucks powerups in and pushes enemy hazards away.',
      'When active, weapons and thrusters divert all energy to the A/R field.',
      'Press [D] to activate Attractor/Repulser.',
    ],
    offsetY: 0.0,
    scaleSmall: 0.5,
    scaleLarge: 1.5,
